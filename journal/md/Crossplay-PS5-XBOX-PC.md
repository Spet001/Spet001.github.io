...
The goal of this project (codenamed ZPGDK BO2CrossplayRelay) is to create a protocol translation bridge between the PC version (specifically GDK x64 MS Store) and consoles (PS4 / PS5 and Xbox 360) via *LAN System Link*.
...
This project is highly experimental but proves that, with enough packet reverse engineering, platform barriers created over 10 years ago can still be broken.
